...
//* unknown
// can accept anything but need to use typeguard before we can use it
...
try {
  doSomethingRisky()
  // useUnknownInCatchVariables: true means we don't have to write e: unknown, defaults automatically to unknown
} catch (e) {
...
//* Almost top type: {} // empty object type
